...
트래픽 제어, 리소스 관리, 애플리케이션 실행, 데이터베이스 모두 클라우드 서버리스 서비스로 실행됩니다. 인프라 프로비저닝과 스케일링에 직접적인 수고를 덜 수 있습니다.

<img src="https://github.com/user-attachments/assets/36b04f7f-cc00-42ec-9a89-e8d998b62df0" width="600px;" height="370px;" />

### 👍 유연한 아키텍처로 배포 및 유지관리가 쉽습니다.
컨테이너 환경에서 운영되는 애플리케이션이므로 번거로운 종속성 관리에 드는 수고가 적습니다. 뿐만 아니라 인프라 설정과 관련된 모든 Key-Value 는 외부에서 주입되는 환경변수로 관리되어 코드를 변경하지 않고도 인프라 변경에 쉽게 대처가 가능합니다.

<img src="https://github.com/user-attachments/assets/3845db3b-2aaa-41fd-94ad-6d4cdbe21611" width="600px;" height="430px;" />


## 🔘 프로젝트 기간
 
<details open>
  <summary>🗓️총 소요기간 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[2023.12.20 ~ 2024.07.27 → 80일간]</summary>
<br>
  <details open>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;⏳보안취약점 보완&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[2024.02.03 ~ 2024.02.03 → 1일간]<br>
  ...
  <details open>
    <summary>&nbsp;&nbsp;&nbsp;⏰배포 및 통합테스트&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[2024.02.04 ~ 2024.07.27 → 34일간] </summary>
...
### 1️⃣ 온프레미스 아키텍처
<img src="https://github.com/user-attachments/assets/ecb2362f-ac29-4599-9830-4864a6c6a0ab" width="700px;" height="450px;" />
<br><br><br>
...
#### ※ CI / CI
<img src="https://github.com/user-attachments/assets/b12499a8-16d4-445c-b3ed-3d527a450bd0" width="700px;" height="450px;" />
<br><br><br>
